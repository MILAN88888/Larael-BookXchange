...
<footer class="section-footer">
			<div class="container">									
				<div class="footer-menu-wrap">
					<ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
						<li class="nav-item"><a class="p-2" href="home">Home</a></li>
						<li class="nav-item"><a class="p-2" href="about">About</a></li>
						<li class="nav-item"><a class="p-2" href="home">Contact</a></li>
					</ul>
				</div>
				<div class="footer-credit pt-2">
					<p>Copyright © BookXchange</p>
				</div>
			</div>
		</footer>
		<!-- footer -->
		...
		<!-- javascript -->
		<script src="{{asset('web_asset/assets/js/jquery.min.js')}}"></script>
